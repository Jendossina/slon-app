...
const I18N = {
  ru: {
    ...
    'bonus.noIiko': 'Данные iiko за неделю не внесены', 'bonus.revenueChecks': '{r} сум · {n} чеков',
    ...
    'adm.clNone': 'Чек-листов пока нет', 'adm.clItemsMedia': '{done} из {total} пунктов · {n} фото/видео прикреплено', 'adm.clWatchAll': '📸 Смотреть все фото ({n})', 'adm.allDates': 'Все даты', 'adm.photoCount': '{n} фото',
  ...
  uz: {
    ...
    'bonus.noIiko': 'Ҳафта учун iiko маълумотлари киритилмаган', 'bonus.revenueChecks': '{r} сўм · {n} чек',
    ...
    'adm.clNone': 'Ҳали чек-листлар йўқ', 'adm.clItemsMedia': '{total} тадан {done} банд · {n} фото/видео бириктирилган', 'adm.clWatchAll': '📸 Барча фотоларни кўриш ({n})', 'adm.allDates': 'Барча саналар', 'adm.photoCount': '{n} фото',
